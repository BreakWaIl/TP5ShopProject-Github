...
return [
    ...
    // +----------------------------------------------------------------------
    //物流秘钥 logistics_key
    'logistics_key'         => '0841fafads9fu0834krhfq',
    //付款状态对应的文本
    'pay_status'            => [
    ...
    'send_status'            => [
        ...
        '<span style="color: gray">已收货</span>',
        '<span style="color: blue">退货中</span>',
        '<span style="color: orange">退货成功</span>',
    ],
    //短信盐加密
    'sms_salt'              => 'OWEFIHSD@*#(&$@(R#@)%&*@^$*(',
    //后台静态文件模板目录
